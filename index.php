...
<body>
                    ...
                    <div class="col-md-6 mx-auto text-center">
                        <div class="input-group">
                            <div class="input-group input-group-lg">
                                <input type="text" name="query" placeholder="タイトル検索" <?php if ($query != '') {
                                                                                            echo ' value ="' . $query . '"';
                                    ...
                                    <div class="accordion-body">
                                        <div class="d-flex">
                                            ...
                                            <select name="season" class="form-select mb-3" aria-label="select002">
                                                ...
                                                <option <?php if ($season == '') {
                                                            echo 'selected';
                                                        } ?> value="">シーズン</option>
                                                <option <?php if ($season == '春') {
                                                            echo 'selected';
                                                        } ?> value="春">春</option>
                                                <option <?php if ($season == '夏') {
                                                            echo 'selected';
                                                        } ?> value="夏">夏</option>
                                                <option <?php if ($season == '秋') {
                                                            echo 'selected';
                                                        } ?> value="秋">秋</option>
                                                <option <?php if ($season == '冬') {
                                                            echo 'selected';
                                                        } ?> value="冬">冬</option>
                                            </select>
                                        </div>
                                        ...
                                        <select name="category" class="form-select mb-3" aria-label="Default select example">
                                            ...
                                            <option <?php if ($category == '') {
                                                        echo 'selected';
                                                    } ?> value="">カテゴリ</option>
                                            <option <?php if ($category == '1') {
                                                        echo 'selected';
                                                    } ?> value="1">キャラクター：声優名</option>
                                            <option <?php if ($category == '2') {
                                                        echo 'selected';
                                                    } ?> value="2">スタッフ</option>
                                            <option <?php if ($category == '3') {
                                                        echo 'selected';
                                                    } ?> value="3">主題歌</option>
                                        </select>
                                        <input type="text" name="detail" <?php if ($detail != '') {
                                                                                echo ' value ="' . $detail . '"';
                                                                            } ?> class="form-control mb-3" aria-label="Sizing example input" aria-describedby="inputGroup-sizing">
                    ...
                    if (allBrowse == 'false') {
                        ...
                        if ($res_arr[$i]['i_code'] != '(NULL)') {
                            ...
                            if ($res_arr[$i]['key_C3'] == "(NULL)" || $res_arr[$i]['key_C3'] == "") {
                                ...
                                echo '<a href="./individual.php?query=' . $res_arr[$i]['code'] . '"><img src="' . thumbnail_url . $res_arr[$i]['key_C3'] . '" calss="card-img-top" alt="#"></a><div class="card-body">';
                            }
    ...
    <!--Reruas APIサーバーにページネーション機能が無いのでコメントアウト-->
    <!--pagination-->
