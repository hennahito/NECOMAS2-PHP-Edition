                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="top-tab" data-bs-toggle="tab" data-bs-target="#top"
                                type="button" role="tab" aria-controls="top" aria-selected="true">
                                トップ
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="characteractor-tab" data-bs-toggle="tab"
                                data-bs-target="#characteractor" type="button" role="tab" aria-controls="characteractor"
                                aria-selected="false">
                                キャラクタ：声優名
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="stuff-tab" data-bs-toggle="tab" data-bs-target="#stuff"
                                type="button" role="tab" aria-controls="stuff" aria-selected="false">
                                スタッフ情報等
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
